...
function sydney_setup() {
	...
	register_nav_menus( array(
        ...
        'primary-category-menu' => __( 'Primary Category Menu', 'sydney' )
	) );
...
wp_enqueue_style('custom-style', get_stylesheet_directory_uri() . '/custom-style.css', ['sydney-style', 'megamenu']);